...
import com.example.recipeDatabase.database.daointerface.AppUserDAO;
...
public class AppUserDAOImpl implements AppUserDAO {
    ...
    public Optional<AppUser> findByUsername(String username) {
        return entityManager.createQuery(
                "SELECT u FROM AppUser u WHERE UPPER(u.username) = UPPER(:username)", AppUser.class)
    ...
    public List<AppUser> findByUserRole(UserRole role) {
        return entityManager.createQuery(
                "SELECT u FROM AppUser u JOIN FETCH u.roles as role WHERE role = :role", AppUser.class)
